...
The resulting vending machine diagram is shown in \fig{fig:EFSM}. The standard Evidence Driven State Merging process can now repeat on this machine, and will likely merge further states, bringing more trace re-use patterns into alignment.
