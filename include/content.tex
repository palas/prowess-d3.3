...
\begin{figure}
\begin{minipage}[t]{1\textwidth}%
\showcodehalfbox{figures/automatic_beh_inf/2-interference/2-out/mod1.erl}%
\end{minipage}
...
\begin{figure}[h]
\begin{center}
%\includegraphics[width=7cm]{figures/efsm/vend3.eps}
...
The resulting vending machine diagram is shown in \fig{fig:EFSM}. The standard EDSM process can now repeat on this machine, and will likely merge further states, bringing more trace re-use patterns into alignment.
